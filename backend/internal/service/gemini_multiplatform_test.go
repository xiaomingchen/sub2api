...
func (m *mockAccountRepoForGemini) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode, oauthPlanType string) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
